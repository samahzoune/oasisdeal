...
const DEST = [
  {code:'EDI', slug:'edinburgh', region:'eu', trend:1, flag:'🇬🇧', cur:'GBP', rslug:'',
    lang_en:'English', lang_fr:'Anglais', lang_ar:'الإنجليزية', ar_name:'إدنبرة', fr_name:'Édimbourg',
    bt_en:'May–Sep · Aug for the Festival', bt_fr:'mai–sep. · août pour le Festival', bt_ar:'مايو–سبتمبر · أغسطس للمهرجان',
    en:'A cliff-top castle, a medieval old town and the wild Highlands at its back.', fr:'Un château perché, une vieille ville médiévale et les Highlands sauvages en toile de fond.', ar:'قلعة على حافة صخرة، ومدينة قديمة من العصور الوسطى، ومرتفعات اسكتلندا البرّية خلفها.',
    lead_en:'Edinburgh crowns a volcanic crag with its castle, tumbles down cobbled closes to the Royal Mile, and opens onto the wild Scottish Highlands. Come May to September for long, bright days, or in August for the world-famous Fringe Festival.', lead_fr:'Édimbourg couronne un piton volcanique de son château, dévale des ruelles pavées jusqu’au Royal Mile, et s’ouvre sur les Highlands sauvages. Venez de mai à septembre pour les longues journées lumineuses, ou en août pour le célèbre Fringe Festival.', lead_ar:'تتوّج إدنبرة صخرة بركانية بقلعتها، وتنحدر عبر أزقّة مرصوفة إلى الرويال مايل، وتنفتح على مرتفعات اسكتلندا البرّية. زُرها من مايو إلى سبتمبر للأيام الطويلة المشرقة، أو في أغسطس لمهرجان فرينج الشهير عالميًا.',
    todo_en:['Explore Edinburgh Castle & the Royal Mile','Climb Arthur’s Seat for the city views','Wander the medieval Old Town closes','Day-trip to the Highlands & Loch Ness'], todo_fr:['Explorer le château et le Royal Mile','Grimper Arthur’s Seat pour la vue','Flâner dans les ruelles médiévales','Excursion dans les Highlands et au Loch Ness'], todo_ar:['استكشاف قلعة إدنبرة والرويال مايل','تسلّق آرثرز سيت لإطلالة المدينة','التجوّل في أزقّة البلدة القديمة','رحلة إلى المرتفعات وبحيرة لوخ نيس']},
  {code:'AMM', slug:'petra', region:'me', trend:1, flag:'🇯🇴', cur:'JOD', rslug:'',
    lang_en:'Arabic', lang_fr:'Arabe', lang_ar:'العربية', ar_name:'البتراء', fr_name:'Pétra',
    bt_en:'Mar–May & Sep–Nov', bt_fr:'mars–mai & sep.–nov.', bt_ar:'مارس–مايو وسبتمبر–نوفمبر',
    en:'A rose-red city carved into desert cliffs — one of the world’s wonders.', fr:'Une cité rose taillée dans des falaises désertiques — une merveille du monde.', ar:'مدينة وردية منحوتة في صخور الصحراء — إحدى عجائب العالم.',
    lead_en:'Petra is Jordan’s rose-red wonder — a whole city carved into sandstone cliffs, reached through the narrow Siq that opens onto the towering Treasury. Fly into Amman, then head south. Spring and autumn bring warm days and cool desert nights, ideal for exploring on foot.', lead_fr:'Pétra est la merveille rose de Jordanie — une cité entière taillée dans le grès, atteinte par l’étroit Siq qui s’ouvre sur le Trésor monumental. Rejoignez Amman, puis filez au sud. Le printemps et l’automne offrent des journées douces et des nuits fraîches du désert, parfaits pour explorer à pied.', lead_ar:'البتراء هي أعجوبة الأردن الوردية — مدينة كاملة منحوتة في صخور الحجر الرملي، يُوصل إليها عبر السيق الضيّق الذي ينفتح على الخزنة الشاهقة. تصل من عمّان ثم تتّجه جنوبًا. الربيع والخريف يمنحان أيامًا دافئة وليالي صحراوية باردة، مثالية للاستكشاف سيرًا.',
    todo_en:['Walk the Siq to the Treasury','Climb to the Monastery (Ad-Deir)','Sleep under the stars in Wadi Rum','See Petra by candlelight at night'], todo_fr:['Marcher dans le Siq jusqu’au Trésor','Monter au Monastère (Ad-Deir)','Dormir à la belle étoile dans le Wadi Rum','Voir Pétra aux chandelles la nuit'], todo_ar:['السير في السيق حتى الخزنة','الصعود إلى الدير','المبيت تحت النجوم في وادي رم','مشاهدة البتراء على ضوء الشموع ليلًا']},
  ...
  {code:'VCE', slug:'dolomites', region:'eu', trend:1, flag:'🇮🇹', cur:'EUR', rslug:'',
    lang_en:'Italian', lang_fr:'Italien', lang_ar:'الإيطالية', ar_name:'الدولوميت', fr_name:'Dolomites',
    bt_en:'Jun–Sep for hiking · Dec–Mar for snow', bt_fr:'juin–sep. rando · déc.–mars neige', bt_ar:'يونيو–سبتمبر للمشي · ديسمبر–مارس للثلج',
    en:'Dramatic pink-gold peaks, emerald lakes and storybook alpine villages.', fr:'Des sommets roses et dorés, des lacs émeraude et des villages alpins de conte.', ar:'قمم وردية ذهبية، وبحيرات زمردية، وقرى جبلية كأنها من قصة.',
    lead_en:'The Dolomites are northern Italy’s most spectacular mountains — jagged peaks that glow at sunrise, turquoise lakes and cosy chalets. Fly into Venice or Verona and drive up. Summer is for hiking, winter for snow and skiing.', lead_fr:'Les Dolomites sont les montagnes les plus spectaculaires du nord de l’Italie — sommets déchiquetés qui s’embrasent au lever du soleil, lacs turquoise et chalets chaleureux. Rejoignez-les depuis Venise ou Vérone. L’été pour la randonnée, l’hiver pour la neige et le ski.', lead_ar:'الدولوميت أروع جبال شمال إيطاليا — قمم مسنّنة تتوهّج عند الشروق، وبحيرات فيروزية، وشاليهات دافئة. تصل إليها من البندقية أو فيرونا. الصيف للمشي، والشتاء للثلج والتزلّج.',
    todo_en:['Watch sunrise alpenglow on the peaks','Hike to Lago di Braies & Tre Cime','Ride a cable car for panoramic views','Stay in a cosy mountain chalet'], todo_fr:['Admirer l’alpenglow au lever du soleil','Randonner au lac de Braies et aux Tre Cime','Prendre un téléphérique pour la vue','Séjourner dans un chalet de montagne'], todo_ar:['مشاهدة توهّج الشروق على القمم','المشي إلى بحيرة براييس وتري تشيمي','ركوب التلفريك لمناظر بانورامية','الإقامة في شاليه جبلي دافئ']},
  {code:'OSL', slug:'norway', region:'eu', trend:1, flag:'🇳🇴', cur:'NOK', rslug:'',
    lang_en:'Norwegian', lang_fr:'Norvégien', lang_ar:'النرويجية', ar_name:'النرويج', fr_name:'Norvège',
    bt_en:'May–Sep · winter for northern lights', bt_fr:'mai–sep. · hiver pour les aurores', bt_ar:'مايو–سبتمبر · الشتاء للشفق القطبي',
    en:'Deep blue fjords, red-cabin villages and the northern lights.', fr:'Des fjords d’un bleu profond, des villages de cabanes rouges et les aurores boréales.', ar:'مضايق زرقاء عميقة، وقرى بأكواخ حمراء، والشفق القطبي.',
    lead_en:'Norway is fjords, waterfalls and jaw-dropping coastal scenery, with the northern lights in winter. Oslo is the main gateway and Bergen is the fjord capital. Long summer days are best for the fjords, dark winters for the aurora.', lead_fr:'La Norvège, ce sont des fjords, des cascades et des paysages côtiers à couper le souffle, avec les aurores boréales en hiver. Oslo est la principale porte d’entrée, Bergen la capitale des fjords. Les longues journées d’été sont idéales pour les fjords, les hivers sombres pour les aurores.', lead_ar:'النرويج مضايق وشلّالات ومناظر ساحلية خلّابة، مع الشفق القطبي شتاءً. أوسلو البوّابة الرئيسية، وبيرغن عاصمة المضايق. أيام الصيف الطويلة الأفضل للمضايق، وليالي الشتاء المظلمة للشفق.',
    todo_en:['Cruise a fjord from Bergen','Chase the northern lights in winter','Ride the Flåm scenic railway','Explore colourful Bryggen wharf'], todo_fr:['Naviguer un fjord depuis Bergen','Chasser les aurores boréales en hiver','Prendre le train panoramique de Flåm','Explorer le quai coloré de Bryggen'], todo_ar:['جولة بحرية في مضيق من بيرغن','ملاحقة الشفق القطبي شتاءً','ركوب قطار فلوم السياحي','استكشاف رصيف بريغن الملوّن']},
  {code:'YYC', slug:'banff', region:'am', trend:1, flag:'🇨🇦', cur:'CAD', rslug:'',
    lang_en:'English', lang_fr:'Anglais', lang_ar:'الإنجليزية', ar_name:'بانف', fr_name:'Banff',
    bt_en:'Jun–Sep · Dec–Mar for skiing', bt_fr:'juin–sep. · déc.–mars pour le ski', bt_ar:'يونيو–سبتمبر · ديسمبر–مارس للتزلّج',
    en:'Turquoise glacier lakes and towering Rocky Mountain peaks.', fr:'Des lacs glaciaires turquoise et les sommets vertigineux des Rocheuses.', ar:'بحيرات جليدية فيروزية وقمم شاهقة في جبال روكي.',
    lead_en:'Banff National Park in the Canadian Rockies is a wonderland of turquoise lakes — Louise and Moraine — glaciers and pine forest. Fly into Calgary and drive up. Summer for hiking and canoeing, winter for world-class skiing.', lead_fr:'Le parc national de Banff, dans les Rocheuses canadiennes, est un royaume de lacs turquoise — Louise et Moraine — de glaciers et de forêts de pins. Rejoignez-le depuis Calgary. L’été pour la randonnée et le canoë, l’hiver pour le ski.', lead_ar:'حديقة بانف الوطنية في جبال روكي الكندية عالم ساحر من البحيرات الفيروزية — لويز ومورين — والأنهار الجليدية وغابات الصنوبر. تصل إليها من كالغاري. الصيف للمشي والتجديف، والشتاء للتزلّج.',
    todo_en:['See turquoise Lake Louise & Moraine Lake','Ride the Banff Gondola','Spot wildlife on a scenic drive','Ski or snowboard in winter'], todo_fr:['Voir les lacs turquoise Louise et Moraine','Prendre la gondole de Banff','Observer la faune sur une route panoramique','Skier ou surfer en hiver'], todo_ar:['رؤية بحيرتي لويز ومورين الفيروزيتين','ركوب تلفريك بانف','رصد الحياة البرّية في جولة خلّابة','التزلّج في الشتاء']},
  {code:'VIE', slug:'austria', region:'eu', trend:1, flag:'🇦🇹', cur:'EUR', rslug:'',
    lang_en:'German', lang_fr:'Allemand', lang_ar:'الألمانية', ar_name:'النمسا', fr_name:'Autriche',
    bt_en:'May–Sep · Dec–Mar for snow', bt_fr:'mai–sep. · déc.–mars pour la neige', bt_ar:'مايو–سبتمبر · ديسمبر–مارس للثلج',
    en:'Fairytale lakeside villages, imperial cities and snowy Alps.', fr:'Des villages de conte au bord des lacs, des villes impériales et des Alpes enneigées.', ar:'قرى خرافية على ضفاف البحيرات، ومدن إمبراطورية، وجبال ألب مكسوّة بالثلج.',
    lead_en:'Austria pairs imperial Vienna and Salzburg with storybook alpine villages like Hallstatt and endless mountains. Fly into Vienna or Salzburg. Summer is for lakes and hiking, December to March for snow and Christmas markets.', lead_fr:'L’Autriche associe la Vienne impériale et Salzbourg à des villages alpins de conte comme Hallstatt et à des montagnes infinies. Rejoignez Vienne ou Salzbourg. L’été pour les lacs et la randonnée, de décembre à mars pour la neige et les marchés de Noël.', lead_ar:'النمسا تجمع بين فيينا الإمبراطورية وسالزبورغ وقرى ألبية خرافية مثل هالشتات وجبال لا تنتهي. تصل من فيينا أو سالزبورغ. الصيف للبحيرات والمشي، ومن ديسمبر إلى مارس للثلج وأسواق الميلاد.',
    todo_en:['Wander fairytale Hallstatt','Explore imperial Vienna & its cafés','Visit Salzburg, Mozart’s city','Hit the Alps for skiing or hiking'], todo_fr:['Flâner dans le conte de fées Hallstatt','Explorer la Vienne impériale et ses cafés','Visiter Salzbourg, la ville de Mozart','Rejoindre les Alpes pour le ski ou la rando'], todo_ar:['التجوّل في هالشتات الخرافية','استكشاف فيينا الإمبراطورية ومقاهيها','زيارة سالزبورغ مدينة موتسارت','التوجّه إلى الألب للتزلّج أو المشي']},
...
const L = {
  en:{dir:'ltr',lang:'en',home:'/',dest:'/destinations/',hotels:'/hotels',cars:'/cars',transfers:'/transfers',esim:'/esim',comp:'/compensation',
  ...
  fr:{dir:'ltr',lang:'fr',home:'/fr/',dest:'/fr/destinations/',hotels:'/hotels',cars:'/cars',transfers:'/transfers',esim:'/esim',comp:'/compensation',
  ...
  ar:{dir:'rtl',lang:'ar',home:'/ar/',dest:'/ar/destinations/',hotels:'/hotels',cars:'/cars',transfers:'/transfers',esim:'/esim',comp:'/compensation',
...
var EXTRA = '<style>'
  ...
  +'.rp-price{font-family:"Fraunces","Fraunces-fb",serif;font-size:2.4rem;font-weight:600;margin-top:16px;color:#fff}.rp-price .pre{display:block;font-family:"IBM Plex Mono",monospace;font-size:.7rem;letter-spacing:.1em;text-transform:uppercase;opacity:.85;font-weight:400;margin-bottom:4px}.rp-price small{display:block;font-family:"Inter","Inter-fb",sans-serif;font-size:.85rem;font-weight:400;opacity:.85;margin-top:4px}'
  ...
  +'.dg-flag{font-size:1.8rem;line-height:1}.dg-name{font-family:"Fraunces","Fraunces-fb",serif;font-size:1.2rem;margin:8px 0 2px}'
...
function fullFooter(lang){
  ...
  function col(h,links){return '<div class="footer-col"><h3>'+h+'</h3>'+links.map(function(l){return '<a href="'+l[0]+'">'+l[1]+'</a>';}).join('')+'</div>';}
