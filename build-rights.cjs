...
const P = {
  ...
  ar: {
    ...
    title:'حقوق المسافر ف الطيران — طالب بحتى 600 يورو | OasisDeal',
    desc:'عرف حقوقك. إلا تأخرت رحلتك 3 سوايع ولا تلغات ولا تعرضتي للـ overbooking، تقدر تطالب بحتى 600 يورو بقانون الاتحاد الأوروبي (EC 261) — بما فيها بزاف ديال رحلات المغرب–أوروبا.',
    h1:'عرف حقوقك ف الطيران', lead:'أغلب المسافرين عمرهم ما كيطالبو بالفلوس اللي شركات الطيران كتسالهم. إلا رحلتك تأخرت ولا تلغات ولا دارو ليك overbooking، قانون الاتحاد الأوروبي (EC 261) يقدر يعطيك الحق ف حتى 600 يورو — حتى على رحلات من السنوات اللي فاتت.',
    amtsH:'شحال تقدر تطالب', amts:[['250 يورو','رحلات قصيرة حتى 1500 كم'],['400 يورو','رحلات متوسطة، 1500–3500 كم'],['600 يورو','رحلات طويلة كثر من 3500 كم']],
    coverH:'شنو هي الرحلات المشمولة', coverP:'قانون EC 261 كيشمل أي رحلة كتقلع من مطار ف الاتحاد الأوروبي/بريطانيا، والرحلات اللي كتوصل لأوروبا على شركة أوروبية. وهادشي كيشمل بزاف ديال الخطوط من وإلى المغرب — مثلا الدار البيضاء–باريس على شركة أوروبية.',
    whenH:'إمتى تقدر تطالب', when:['وصلتي بتأخير 3 سوايع ولا كثر لوجهتك','الرحلة تلغات بإشعار أقل من 14 يوم','منعوك من الصعود بسبب overbooking','فاتتك correspondance بسبب التأخير'],
    notH:'إمتى عادة ماتقدرش', notP:'الظروف الاستثنائية اللي خارجة على إرادة الشركة — طقس خطير، إضرابات ديال أطراف خارجية، عدم استقرار سياسي ولا مخاطر السلامة — عادة ماكيناش فيها تعويض.',
    howH:'كيفاش تطالب — خطوة بخطوة', steps:[
      ['شيك واش عندك الحق','استعمل الفحص المجاني ديالنا (30 ثانية) باش تشوف واش رحلتك مؤهلة ف EC 261.'],
      ['جمع تفاصيل الرحلة','رقم الحجز، رقم الرحلة والتاريخ عادة كافيين — ماكتحتاجش الفواتير.'],
      ['قدّم الطلب','بلاش عبر شريكنا AirHelp، اللي كيتكلف بالشركة وبالأوراق نيابة عليك.'],
      ['خود فلوسك','بلا ربح، بلا خلاص — إلا نجح الطلب، الفلوس كتجيك ناقص عمولة النجاح. وإلا ما نجحش، ماكتخلص والو.']],
    ctaH:'شيك على اللي خاصك تاخد', ctaP:'بلاش، كتاخد دقيقتين، وماكتخلص غير إلا ربح الملف ديالك.', cta:'شيك على التعويض ديالي →', cta2:'بدا الملف ديالي بلاش →',
    faqH:'أسئلة حول حقوق المسافر', faq:[
      ['حتى لشحال نقدر نطالب لور؟','عادة رحلات من 1 ل 3 سنين اللي فاتو، وكثر ف بعض الدول.'],
      ['شحال كتكلف المطالبة؟','الفحص بلاش، والمطالبة بلا ربح بلا خلاص. العمولة كتتاخد غير إلا تخلصتي.'],
      ['واش رحلات المغرب–أوروبا داخلة؟','غالبا إيه — أي رحلة كتقلع من مطار أوروبي مشمولة، وكذلك الرحلات لأوروبا على شركة أوروبية.'],
      ['وإلا الشركة رفضات؟','شريكنا كيتكلف بالنزاع وكيصعّدو قانونيا إلا لزم الأمر.']],
    note:'OasisDeal ماشي مكتب محاماة؛ الملفات كيتكلف بيها شريكنا AirHelp. يمكن ناخدو عمولة بلا أي زيادة عليك.',
    secure:'آمن ومجاني · بلا ربح بلا خلاص'
  }
};
