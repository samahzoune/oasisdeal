...
// ---- sitemap ----
var urls=['/','/hotels','/cars','/transfers','/esim','/compensation','/flight-rights','/fr/flight-rights','/ar/flight-rights','/about','/contact','/privacy'].map(function(p){return 'https://oasisdeal.com'+p;});
