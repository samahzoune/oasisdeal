...
const L = {
  en:{dir:'ltr',lang:'en',home:'/',hotels:'/hotels',esim:'/esim',comp:'/compensation',nav:{flights:'Flights',hotels:'Hotels',esim:'eSIM',dest:'Destinations',comp:'Compensation'},
  ...
  fr:{dir:'ltr',lang:'fr',home:'/fr/',hotels:'/hotels',esim:'/esim',comp:'/compensation',nav:{flights:'Vols',hotels:'Hôtels',esim:'eSIM',dest:'Destinations',comp:'Indemnisation'},
  ...
  ar:{dir:'rtl',lang:'ar',home:'/ar/',hotels:'/hotels',esim:'/esim',comp:'/compensation',nav:{flights:'رحلات',hotels:'فنادق',esim:'eSIM',dest:'الوجهات',comp:'تعويضات'},
...
function nav(lang,slug){var x=L[lang];
  ...
  return '<nav class="nav"><div class="container nav-row"><a class="logo" href="'+x.home+'">'+LOGO+'<span class="logo-word">Oasis<span class="pipe">|</span>Deal</span></a><div class="nav-links">'
    +'<a class="nav-link" href="'+x.home+'">'+x.nav.flights+'</a><a class="nav-link" href="'+x.hotels+'">'+x.nav.hotels+'</a><a class="nav-link" href="'+x.esim+'">'+x.nav.esim+'</a><a class="nav-link" href="'+(lang==='en'?'':'/'+lang)+'/destinations/">'+x.nav.dest+'</a><a class="nav-link" href="'+x.comp+'">'+x.nav.comp+'</a><span class="rp-langs">'+langs+'</span></div></div></nav>';}
