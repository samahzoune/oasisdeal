...
function footer(lang){var x=L[lang];return '<footer class="footer"><div class="container"><div class="footer-trust">🔒 '+x.secure+'</div><div class="footer-bottom"><span>© <span id="y">2026</span> OasisDeal</span></div></div></footer><script>document.getElementById("y").textContent=new Date().getFullYear();</script>'+NAVJS;}
...
function pageHtml(cmp,lang){
  ...
  return '<!DOCTYPE html>\n<html lang="'+x.lang+'" dir="'+x.dir+'">\n<head>\n<meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><meta name="p:domain_verify" content="1f6676c70992e08fca792b0978b916b9" />\n'
    ...
    +'<meta property="og:title" content="'+pageTitle(cmp,lang)+'" /><meta property="og:description" content="'+metaDesc(cmp,lang)+'" /><meta property="og:url" content="'+self+'" /><meta property="og:type" content="website" /><meta property="og:image" content="https://oasisdeal.com/images/og-default.png" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:image" content="https://oasisdeal.com/images/og-default.png" />\n'
