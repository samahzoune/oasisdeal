...
const L = {
  en:{dir:'ltr',lang:'en',home:'/',hotels:'/hotels',cars:'/cars',esim:'/esim',comp:'/compensation',nav:{flights:'Flights',hotels:'Hotels',cars:'Cars',esim:'eSIM',dest:'Destinations',blog:'Blog',comp:'Compensation'},
      ...
      note:'Live starting prices from our partners; prices change daily and the final price is set by the airline. We may earn a commission at no extra cost to you.',secure:'Secure & free to use · No booking fees'},
...
function pageHtml(cmp,lang){
  ...
  return '<!DOCTYPE html>\n<html lang="'+x.lang+'" dir="'+x.dir+'">\n<head>\n<meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" />\n'
    ...
    +'<p class="rp-note">'+x.note+'</p></main>'+footer(lang)+liveScript(cmp)+STAY22+'\n</body>\n</html>\n';
}
